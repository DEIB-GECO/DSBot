...
class Dataset:
    ...
    def set_characteristics(self):
        ...
        print('mv', self.missingValues, 'cat', self.categorical, 'zv', self.zeroVariance, 'mf', self.moreFeatures,
    ...
    def filter_kb(self, kb):
        ...
        for i in self.__dict__:
            if (str(i) in ['missingValues', 'categorical', 'onlyCategorical', 'zeroVariance', 'hasLabel',
                           'moreFeatures', 'outliers']):
                if getattr(self, i):
